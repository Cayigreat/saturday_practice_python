...
# La variable auxiliar(sum) nos sirve de acumulador
aux_sum = 0
for grade in student["grades"]:
    aux_sum = aux_sum + grade

# Alternativamente, podemos sumar directamente pasando el arreglo a la función
# fsum, que sirve para sumar floats, importando función math
...
# Si queremos sumar números enteros, tenemos una función más fácil
# que es la función sum()
